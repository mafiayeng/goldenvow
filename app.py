...
def force_reset():
    ...
    Admin.query.filter_by(is_super_admin=True).delete()
    db.session.commit()
    ...
    db.session.commit()
    return """
    <h2>✅ Super admin reset complete.</h2>
    <p>Username: <strong>super</strong><br>Password: <strong>super123</strong></p>
    <p>Now <a href="/login">login here</a>.</p>
    """
...
# ---------- SUPER ADMIN CREATION (legacy, keep for reference) ----------
...
<div class="row">
    <div class="col-md-3 admin-sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ url_for('register_admin') }}"><i class="bi bi-person-plus"></i> Register Admin</a></li>
...
@app.route('/super/register_admin', methods=['GET', 'POST'])
@super_admin_required
def register_admin():
    if request.method == 'POST':
...
<div class="row justify-content-center mt-4">
    <div class="col-md-6">
        <div class="card glass-card">
            <div class="card-header"><h4>Register New Admin</h4></div>
            <div class="card-body">
                <form method="post">
                    <div class="mb-3"><label>Username</label><input type="text" name="username" class="form-control" required></div>
                    <div class="mb-3"><label>Email</label><input type="email" name="email" class="form-control" required></div>
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" name="is_super" id="is_super" class="form-check-input">
                        <label for="is_super" class="form-check-label">Super Admin (full control)</label>
                    </div>

# =============================================================================
# GOLDENVOW – COMPLETE APPLICATION (ALL FEATURES, ALL MODELS, ALL ROUTES)
# =============================================================================
...
</div></body></html>""", event=event, total_raised=total_raised, chat_messages=chat_messages,
                                      testimonials=testimonials, daily_note=daily_note, contributor=contributor,
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
<style>body{background:#0b1120;color:#e2e8f0;padding:20px}.golden-text{color:#D4AF37}.glass-card{background:rgba(255,255,255,0.06);backdrop-filter:blur(12px);border:1px solid rgba(255,255,255,0.08);border-radius:24px;padding:20px}</style>
</head><body><div class="container"><h2 class="golden-text">Contributors - {{ event.title }}</h2>
...
</div></body></html>""", event=event, contributors=contributors, get_event_total_contributions=get_event_total_contributions)
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
<style>body{background:#0b1120;color:#e2e8f0;padding:20px}.golden-text{color:#D4AF37}.glass-card{background:rgba(255,255,255,0.06);backdrop-filter:blur(12px);border:1px solid rgba(255,255,255,0.08);border-radius:24px;padding:20px}</style>
</head><body><div class="container"><h2>{{ contrib.name }}</h2><p>Phone: {{ contrib.phone }}</p><p>Pledge: KES {{ contrib.pledge_amount|round(2) }}</p><p>Paid: KES {{ contrib.paid_amount|round(2) }}</p><p>Status: {{ contrib.status }}</p>
...
</div></body></html>""", contrib=contrib, event=event, payments=payments, show_payments=show_payments)
